...
export function ChartTooltip({ time, rows }: { time: string; rows: TooltipRow[] }) {
  return (
    <div className="min-w-[196px] rounded-md border border-border bg-card px-3 py-2 text-[12px] shadow-[0_4px_16px_--alpha(var(--foreground)/8%)]">
      <div className="mb-1.5 whitespace-nowrap text-foreground">{time}</div>
