  ...
  return (
    ...
    >
      <select
        ...
        data-size={size}
        className={cn(
          'h-8 w-full min-w-0 appearance-none rounded-md border border-input bg-transparent px-2.5 py-0 pr-8 text-sm shadow-xs transition-[color,box-shadow] outline-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed data-[size=sm]:h-7 data-[size=sm]:text-xs dark:bg-input/30 dark:hover:bg-input/50',
      ...
      />
      <ChevronDownIcon
        className="pointer-events-none absolute top-1/2 right-2.5 size-3.5 -translate-y-1/2 text-muted-foreground opacity-50 select-none"
        aria-hidden="true"
