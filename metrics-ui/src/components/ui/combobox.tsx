...
function ComboboxTrigger({
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn("[&_svg:not([class*='size-']):not([data-slot=combobox-icon])]:size-4", className)}
      {...props}
    >
      {children}
      <ChevronsUpDownIcon data-slot="combobox-icon" className="pointer-events-none size-3 shrink-0 text-muted-foreground" />
    </ComboboxPrimitive.Trigger>
  )
}
