...
title: Configure error alerts and destinations
sidebarTitle: Alerts
...
icon: lucide:bell
prompt: |
  Write the alerts guide from @/cli/src/alerts.ts, @/cli/src/destinations.ts,
  @/website/src/alert-check.ts, and @/db/src/schema.ts.
---
