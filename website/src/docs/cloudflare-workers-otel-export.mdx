...
title: Query Cloudflare Workers OTel in Strada
...
icon: lucide:cloud
prompt: |
  Write the Cloudflare Workers OTel export reference from
  @/sdk/src/cloudflare.ts and @/example-app-cloudflare/src/app.tsx.
---
